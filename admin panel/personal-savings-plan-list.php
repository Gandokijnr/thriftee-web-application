    ...
    <section class="section dashboard">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">INDIVIDUAL SAVINGS PLAN</h5>
              ...
              <table class="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col">Saving Object</th>
                    <th scope="col">Break Date</th>
                    <th scope="col">Amount/SCHEDULE</th>
                  </tr>
                </thead>
                <tbody>
                <?php
                                    ...
                                    $select = "SELECT * FROM `thriftee_personal`";
                                    ...
                                    if ($result) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            $ID = $row['USER_ID'];
                                            $EMAIL = $row['EMAIL'];
                                            $SAVING_OBJECT = $row['SAVING_OBJECT'];
                                            $BREAK_DATE = $row['BREAK_DATE'];
                                            $AMOUNT = $row['AMOUNT'].' / '. $row['CHARGE_SCHEDULE'];
