    ...
    <section class="section dashboard">
      ...
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">LOAN APPLICANTS </h5>

              <!-- Default Table -->
              <table class="table" style="display: block; height: 1000px; border: 1px solid green; overflow: auto;">
                <thead>
                  <tr >
                    <th scope="col">ID</th>
                    ...
                    <th scope="col">ACTION_________</th>
                  </tr>
                </thead>
                <tbody>
                <?php
                                    ...
                                    $select = "SELECT * FROM `thrift_loan` ORDER BY EMAIL";
