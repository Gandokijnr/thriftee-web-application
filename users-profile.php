          ...
          <div class="card">
            <div class="card-body pt-3">
              ...
              <div class="tab-content pt-2">
                ...
                $bankaccount = mysqli_real_escape_string($connect, $_POST['bankaccount']);
                $country = mysqli_real_escape_string($connect, $_POST['country']);
                $address = mysqli_real_escape_string($connect, $_POST['address']);

                  

                  $update_tb = "UPDATE thrift_registration SET PHONE_NUMBER ='$phone', NEXT_OF_KIN ='$nextofkin', BANK_NAME ='$bankname', ACCOUNT_NUMBER ='$bankaccount', COUNTRY ='$country', ADDRESS = '$address' WHERE EMAIL = '$_SESSION[USER_ID]'";

                  $query_result = mysqli_query($connect, $update_tb);
                  ...
                  <form id="form" action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="fullName" type="text" readonly class="form-control" id="" value="<?php echo $FULLNAME; ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label class="col-md-4 col-lg-3 col-form-label">Next of Kin</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="nextofkin" type="text" class="form-control" id="" value="<?php echo $NEXTOFKIN ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="bankname" type="text" class="form-control" id="" value="<?php echo $BANKNAME ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="bankaccount" type="text" class="form-control" id="" value="<?php echo $BANKACCOUNT ?>">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="email" type="email" class="form-control" id="Email" value="<?php echo $_SESSION['USER_ID'] ?>">
                      </div>
                    </div>
